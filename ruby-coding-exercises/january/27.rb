...
# https://www.crondose.com/2017/01/replicate-rails-image_tag-method-ruby/
require 'rspec'
...
describe 'Cloned image_tag' do
  ...
  it 'generates an HTML link' do
    expect(
      ...
      "<img src='https://devcamp.com/some_pic.jpg'>"
    )
  end
  ...
  it 'generates an HTML link and can optionally take a width' do
    expect(
      ...
      "<img src='https://devcamp.com/some_pic.jpg' width='42'>"
    )
  end
  ...
  it 'generates an HTML link and can optionally take an alt tag' do
    expect(
      ...
      "<img src='https://devcamp.com/some_pic.jpg' width='42' alt='My Image'>"
    )
  end

  it 'generates an HTML link and \
  can optionally take any type of attribute tag' do
    random = rand 100
    expect(
      image_tag(@image_path, random_value: random)
    ).to eq(
      "<img src='https://devcamp.com/some_pic.jpg' random_value='#{random}'>"
    )
  end
end
