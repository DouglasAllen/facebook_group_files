...
loop do
  jd = DateTime.now.to_time.utc.to_datetime.ajd.to_f
  ...
  ma = [357.52911, 35_999.05030, -0.0001559, -0.00000048, 0, 0]
  ma = [1_287_104.793048, 129_596_581.0481, - 0.5532, 0.000136, - 0.00001149]
  tm2 = ma.each_with_index.reduce(0) { |a, (e, i)| a + e * t**i } / 3600
  ...
  altitude = Math.asin(Math.sin(latitude.to_rad) *
                       ...
                       Math.cos(h.to_rad)).to_deg.round(12)
  ...
  puts '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
  puts "| elevation = #{altitude}    |"
  puts "| direction = #{180 + azimuth}    |"
  puts '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
  sleep 1
end
