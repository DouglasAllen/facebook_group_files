...
Dir.chdir 'a_very_short_ruby_program'
system 'ruby matz.rb'
...
Dir.chdir '../issue_a_system_command'
system 'ruby matz_5.rb'
system 'ruby matz_6.rb'
Dir.chdir '../appending_a_string'
